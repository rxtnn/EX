...
<div class="container">
    ...
    <section id="heroSlider" class="hero-slider fade-in-up mb-5">
        <div class="slides">
            <div class="slide" style="background-image:url('/exam/assets/images/hero1.jpg')">
                <div class="caption">
                    <h1>Курсы вождения речного транспорта</h1>
                    <p class="lead">Катер, круизный лайнер, яхта — научим управлять уверенно</p>
                </div>
            </div>
            <div class="slide" style="background-image:url('/exam/assets/images/hero2.jpg')">
                <div class="caption">
                    <h1>Опытные инструкторы</h1>
                    <p class="lead">Программы для новичков и продолжающих</p>
                </div>
            </div>
            <div class="slide" style="background-image:url('/exam/assets/images/hero3.jpg')">
                <div class="caption">
                    <h1>Практика на современной технике</h1>
                    <p class="lead">Полный цикл: теория, тренажер, выход на воду</p>
                </div>
            </div>
            <div class="slide" style="background-image:url('/exam/assets/images/hero4.jpg')">
                <div class="caption">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card transport-card">
                    <img src="/exam/assets/images/transport1.jpg" alt="Катер">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card transport-card">
                    <img src="/exam/assets/images/transport2.jpg" alt="Круизный лайнер">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card transport-card">
                    <img src="/exam/assets/images/transport3.jpg" alt="Яхта">
                    <div class="card-body">
    ...
    <section class="mb-5">
        <div class="bg-primary-deep text-white p-4 p-md-5 rounded-3 text-center fade-in-up">
            ...
            <?php if (is_user()): ?>
                <a href="/exam/apply.php" class="btn btn-turquoise btn-lg pulse"><i class="bi bi-file-earmark-plus"></i> Подать заявку</a>
            <?php else: ?>
                <a href="/exam/register.php" class="btn btn-turquoise btn-lg me-2 pulse"><i class="bi bi-person-plus"></i> Регистрация</a>
                <a href="/exam/login.php" class="btn btn-light btn-lg">Войти</a>
            <?php endif; ?>
        </div>
    </section>
</div>
